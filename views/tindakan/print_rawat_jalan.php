    ...
    <div class="row">
      ...
      <div class="col-xs-12 table-responsive">
        ...
        <div class="floating-box">
          <img src="<?= Yii::getAlias('@web/theme/') ?>img/logo_with_text.png?>"  style="margin-left: 20px;"/>
        ...
        No. RM: <h6 style="text-align: center;font-size: 25px"><?=$model->pasien->no_rm;?></h6>
        </div>     
          ...
          <thead>
            <tr>
              <td style="width: 600px;border: 0px;padding-left:24px ">
                &nbsp;&nbsp;&nbsp;Nama &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $model->pasien->nama; ?>
               </td>     

              <td style="width: 600px;border: 0px;padding-left:70px">
                &nbsp;&nbsp;&nbsp;Umur/Tgl. Lahir &nbsp; &nbsp;:  <?= Pasien::getAge($model->pasien->tanggal_lahir);?>/<?php
                use app\models\Helper;
                echo Helper::dateFormat($model->pasien->tanggal_lahir); ?></td>
            </tr>
            <tr>
              <td style="width: 600px;border: 0px;padding-left:24px">&nbsp;&nbsp;&nbsp;No KTP &nbsp;&nbsp;:&nbsp;<?= $model->pasien->no_ktp; ?> </td>
              <td style="width: 600px;border: 0px;padding-left:70px">&nbsp;&nbsp;&nbsp;Kategori Pasien &nbsp;&nbsp;: <?php echo strtoupper($model->pasien->kategori_pasien); ?></td>
            </tr>
            <tr>
              <td style="width: 600px;border: 0px;padding-left:24px">&nbsp;&nbsp;&nbsp;Alamat&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo $model->pasien->alamat; ?> </td>
            </tr>
            </thead>
        </table>
